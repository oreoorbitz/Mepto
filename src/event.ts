...
;(function ($: MeptoStatic) {
    ...
    events.split(/\s/).forEach(function (event) {
      ...
      if (handler.e in hover)
        callback = function (e: Event) {
          ...
          if (
            !related ||
            (related !== this && !$.contains(this as Element, related as Element))
          )
      ...
      handler.proxy = function (e: Event) {
        e = compatible(e)
        if ((e as Event & { isImmediatePropagationStopped(): boolean }).isImmediatePropagationStopped()) return
        ;(e as Event & { data?: unknown }).data = data
        const args = (e as Event & { _args?: unknown[] })._args
      const result = cb.apply(
          element,
          args == undefined ? [e] : [e].concat(args as Event[])
        )
  ...
  ;($.fn as unknown as Record<string, any>).one = function (event: any, selector: any, data: any, callback: any, one: any) {
  ...
  function compatible(event: Event, source?: Event): Event {
    ...
    if (
      source ||
      !(evt as Event & { isDefaultPrevented?: () => boolean }).isDefaultPrevented
    ) {
      source || (source = event)
      ...
      if (
        (source as Event).defaultPrevented !== undefined
          ...
          : 'returnValue' in source
            ...
            : (source as Event & { getPreventDefault?: () => boolean })
                  .getPreventDefault &&
  ...
  ;($.fn as unknown as Record<string, any>).delegate = function (selector: any, event: any, callback: any) {
    return this.on(event, selector, callback)
  }

  ;($.fn as unknown as Record<string, any>).undelegate = function (selector: any, event: any, callback: any) {
    return this.off(event, selector, callback)
  }

  ;($.fn as unknown as Record<string, any>).on = function (event: any, selector: any, data: any, callback: any, one: any) {
    ...
    return $this.each(function (_: number, element: Element) {
      if (one)
        autoRemove = function (e: Event) {
          ...
          return (callback as (...args: unknown[]) => unknown).apply(
            this,
            arguments
          )
        }
  ...
  ;($.fn as unknown as Record<string, any>).off = function (event: any, selector: any, callback: any) {
    const $this = this
    if (event && !isString(event)) {
      $.each(
        event as Record<string, (...args: unknown[]) => unknown>,
    ...
    if (!isString(selector) && !isFunction(callback) && callback !== false)
      (callback = selector as (...args: unknown[]) => unknown),
        (selector = undefined)
  ...
  ;($.fn as unknown as Record<string, any>).trigger = function (event: any, args: any) {
    ...
    return this.each(function () {
      ...
      if (
        ...
        typeof (this as unknown as Record<string, unknown>)[(evt as Event).type] ==
          'function'
      )
        (this as unknown as Record<string, () => void>)[(evt as Event).type]()
      // items in the collection might not be DOM elements
      else if ('dispatchEvent' in this)
        (this as EventTarget).dispatchEvent(evt as Event)
    ...
    this.each(function (_: number, element: Element) {
      ...
      $.each(
        ...
        function (_: number, handler: Handler) {
          ...
          if (
            (e as Event & { isImmediatePropagationStopped(): boolean }).isImmediatePropagationStopped()
          )
            return false
        }
      )
  ...
  ;(
    ...
    .forEach(function (event: string) {
      const $fn = ($.fn as unknown) as Record<string, (callback?: (...args: unknown[]) => unknown) => unknown>
  ...
  ;($.Event as unknown as (type: any, props?: any) => Event) = function (type: any, props?: any) {
    if (!isString(type))
      (props = type as Record<string, unknown>),
        (type = (props as Record<string, string>).type)
    const event = document.createEvent(
      specialEvents[type as string] || 'Events'
    )
    let bubbles = true
    if (props)
